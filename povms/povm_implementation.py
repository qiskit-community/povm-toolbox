...
class POVMImplementation:
    ...
    def _build_qc(self) -> QuantumCircuit:
        ...
        raise NotImplementedError(
            "The subclass of POVMImplementation must implement `_build_from_param` method."
        )
    ...
    def get_parameter_and_shot(self, shot: int) -> QuantumCircuit:
        ...
        """
        raise NotImplementedError(
            "The subclass of POVMImplementation must implement `get_parameter_and_shot` method."
        )
    ...
    def to_povm(self) -> Povm:
        ...
        """
        raise NotImplementedError(
            "The subclass of POVMImplementation must implement `to_povm` method."
        )
