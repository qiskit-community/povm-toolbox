...
def dual_from_marginal_probabilities(
    ...
    Args:
        ...
        threshold: if an outcome probability is below the value of ``threshold``,
            ...
            distribution. This is designed to avoid having parameters of the
            frame super-operator set to zero, which would result in a
            ``ZeroDivisionError``.
    ...
    joint_prob: np.ndarray = povm.get_prob(state)  # type: ignore
    alphas = []
