...
Following Ref. |_| [oszmaniec_simulating_2017]_, the set of
...
.. container:: proof
   ...
   *Proof.* The elements of :math:`\mathbf{M}`, given by
   ...
   .. math:: \sum_k M_k = p \sum_k M_{1,k} + (1-p) \sum_k M_{2,k} = p  \mathbb{I}_\mathcal{H} + (1-p)  \mathbb{I}_\mathcal{H} =  \mathbb{I}_\mathcal{H} \, ,
...
.. math:: \mathbf{M} = \sum_i q_i \mathbf{M}_i \, \in \mathcal{M}(d,n)

as a corollary of Lemma |_| [#lem_convex]_.

The set of all convex combinations generated by a set
:math:`\mathcal{S} = \{\mathbf{M}_i\}`, i.e. |_| its convex hull, is denoted by
...
.. container:: example
   ...
   .. math:: \frac{1}{3} \mathbf{M} + \frac{2}{3}\mathbf{N} = \{ \, \frac{1}{3} M_1 + \frac{2}{3} N_1\, , \; \frac{1}{3} M_2 + \frac{2}{3} N_2 \, \} \in \mathcal{M}(2,2)\, ,

   and also

   .. math:: \frac{1}{3} \{M_1,  M_2,0,0\} + \frac{2}{3} \{0,0,N_1,  N_2\} =  \{\frac{1}{3} M_1 \, , \; \frac{1}{3} M_2 \, , \;  \frac{2}{3} N_1 \, , \;  \frac{2}{3} N_2\} \in \mathcal{M}(2,4)\, ,
...
.. math:: \mathbf{M}_1 \uplus \mathbf{M}_2 = \{ M_{1,k}\}_k \uplus \{M_{2,k}\}_k =  \{ M_{i,k}\}_{i,k}
...
.. math:: \mathbf{M} = \biguplus_i q_i \mathbf{M}_i = \left\{ q_i M_{i,k} \right\}_{i,k} \ \in \mathcal{M}(d, {\textstyle\sum_i} n_i)

where the outcomes are now denoted by the pair :math:`(i,k)`.


.. [oszmaniec_simulating_2017] oszmaniec_simulating_2017.
